...
public class IntegrationTests {
    ...
    private int countIntersections(Intersectable shape, Camera camera, int nY, int nX){
        ...
        for(int i = 0; i < nY; i++ ){
            for(int j = 0; j< nX; j ++ ){
                List<Point> x = shape.findIntsersections(camera.constructRay(nX, nY, j, i));
                sum += x == null ? 0 : x.size(); 
            }
        } 
        return sum; 
    ...
    public void  testSphere(){
        ...
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),2 , 0.00001 );
        ...
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),18 , 0.00001 );

        sp = new Sphere(new Point(0,0,-2), 2);
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),10 , 0.00001 );
        
        sp = new Sphere(new Point(0,0,-2), 4);
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),9 , 0.00001 );

                
        sp = new Sphere(new Point(0,0,1), 0.5);
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),0 , 0.00001 );
    }
    ...
    public void  testTriangle(){
        ...
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),1 , 0.00001 );
    ...
    public void  testPlane(){
        ...
        assertEquals("intersecion are messed up", countIntersections(sp,cmr, ny, nx),6 , 0.00001 );
