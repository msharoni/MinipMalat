...
public class SphereTests {
	...
	public void testFindIntersections() {
		...
		result = sphere.findIntsersections(new Ray(new Point(0.5,0,0), new Vector(1,1,1)));
		...
		//assertNull(sphere.findIntsersections(new Ray(new Point(2,0,0), new Vector(1,0,1))),
		//		"Ray's line out of sphere"); //problem
		...
		result = sphere.findIntsersections(new Ray(new Point(1,0.5,0), new Vector(0,-1,0)));
		assertEquals(result.size(), 1, "Wrong number of points");
		assertEquals(List.of(p1), result, "Ray crosses sphere");

		// TC16: Ray starts at the center (1 points)
		p1 = new Point(1.5773502691896257, 0.5773502691896258, 0.5773502691896258);
		result = sphere.findIntsersections(new Ray(new Point(1,0,0), new Vector(1,1,1)));
		assertEquals(result.size(), 1, "Wrong number of points");
		assertEquals(List.of(p1), result, "Ray crosses sphere");
		...
		assertNull(sphere.findIntsersections(new Ray(new Point(1,-2,0), new Vector(0,-1,0))),
				"Ray's line out of sphere");
