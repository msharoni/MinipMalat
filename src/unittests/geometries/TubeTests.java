...
public class TubeTests {
	...
	void testFindIntersections() {
		...
		assertNull(tube.findIntsersections(new Ray(new Point(6, 4, 5), new Vector(2,-6,-5))),
		...
		List<Point> result = tube.findIntsersections(new Ray(new Point(-6, 0, 0), new Vector(14, 6, 3)));
		...
		result = tube.findIntsersections(new Ray(new Point(-1,0,0), new Vector(9,6,3)));
		...
		assertNull(tube.findIntsersections(new Ray(new Point(4, 0, 0), new Vector(4,-2,0))),
				"Ray's line out of tube");
		...
		result = tube.findIntsersections(new Ray(new Point(3,1,0), new Vector(3,2,0)));
		assertEquals(result.size(), 1, "Wrong number of points");
		assertEquals(List.of(p1), result, "Ray crosses tube");

		// TC12: Ray starts at sphere and goes outside (0 points)
		assertNull(tube.findIntsersections(new Ray(new Point(6,3,0), new Vector(3,3,1))),
				"Ray's line out of tube");
		...
		p1 = new Point(-4, 0, 0);
		p2 = new Point(4, 0, 0);
		result = tube.findIntsersections(new Ray(new Point(-6,0,0), new Vector(14,0,0)));
		...
		result = tube.findIntsersections(new Ray(new Point(-2,0,0), new Vector(8,0,0)));
		assertEquals(result.size(), 1, "Wrong number of points");
		assertEquals(List.of(p1), result, "Ray crosses tube");

		// TC15: Ray starts inside (1 points)
		p1 = new Point(4, 0, 0.0);
		result = tube.findIntsersections(new Ray(new Point(2,0,0), new Vector(6,0,0)));
		assertEquals(result.size(), 1, "Wrong number of points");
		assertEquals(List.of(p1), result, "Ray crosses tube");

		// TC16: Ray starts at the center (1 points)
		p1 = new Point(4, 0.0, 0.0);
		result = tube.findIntsersections(new Ray(new Point(0,0,0), new Vector(8,0,0)));
		assertEquals(result.size(), 1, "Wrong number of points");
		assertEquals(List.of(p1), result, "Ray crosses sphere");

		// TC17: Ray starts at sphere and goes outside (0 points)
		assertNull(tube.findIntsersections(new Ray(new Point(4,0,0), new Vector(4,0,0))),
				"Ray's line out of tube");

		// TC18: Ray starts after sphere (0 points)
		assertNull(tube.findIntsersections(new Ray(new Point(6,0,0), new Vector(2,0,0))),
				"Ray's line out of tube");

		// **** Group: Ray's line is tangent to the tube (all tests 0 points)
		// TC19: Ray starts before the tangent point
		assertNull(tube.findIntsersections(new Ray(new Point(4,-5,0), new Vector(0,3,0))),
				"Ray's line out of tube");

		// TC20: Ray starts at the tangent point
		assertNull(tube.findIntsersections(new Ray(new Point(4,0,0), new Vector(0,3,0))),
				"Ray's line out of tube");

		// TC21: Ray starts after the tangent point
		assertNull(tube.findIntsersections(new Ray(new Point(4,1,0), new Vector(0,3,0))),
				"Ray's line out of tube");

		// **** Group: Special cases
		// TC19: Ray's line is outside, ray is orthogonal to ray start to tube's center line
		assertNull(tube.findIntsersections(new Ray(new Point(6,1,0), new Vector(0,2,0))),
				"Ray's line out of tube");
	}
}
