...
public class PlaneTests {
	...
	void testFindIntersections() {
		...
		assertEquals(List.of(new Point(-5d/3d, -7d/6d, 20d/3d)), p1.findIntsersections(r1),
		...
		assertEquals(List.of(new Point(5d/3d, -1d/3d, -5d/3d)), p1.findIntsersections(r5),
		...
		assertNull(p1.findIntsersections(r7),
		...
		assertNull(p1.findIntsersections(r8),
		...
		assertNull(p1.findIntsersections(r9),//problem
				"findIntersections() for neither orthogonal nor parallel Ray in the plane is wrong");
	}
}
