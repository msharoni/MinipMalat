...
public class PlaneTests {
	...
	public void testConstructor() {
		...
		// TC03: Vertex that creates co-linear vectors
		assertThrows(IllegalArgumentException.class, //
				() -> new Polygon(new Point(0, 0, 1), new Point(0, 0, 0), new Point(0, 0,2), new Point(0, 0.5, 0.5)),
				"Constructed a plane that his base vectors are co-linear");
	...
	public void testGetNormal() {
		...
		"Bad normal to Plane");	 
		assertEquals(1,pl.getNormal(new Point(0, 1, 0)).length(),0.00001,"the normal is not normalize");
	...
	void testFindIntersections() {
		...
		//TC02: Ray does not intersect with the plane
