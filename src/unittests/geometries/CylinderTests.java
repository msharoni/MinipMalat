...
public class CylinderTests {
	...
	public void testGetNormal() {
        ...
        assertEquals(new Vector(0, 0, 1), pl.getNormal(new Point(0, 1, 1)), "Bad normal to trinagle");

		// =============== Boundary Values Tests ==================

        assertEquals(new Vector(1, 0, 0), pl.getNormal(new Point(1, 0, 0)), "Bad normal to trinagle");
